...
<section class="pg" id="pg-links">
  ...
  <div class="cp">
    ...
    <div class="cp-body">
      ...
      <div class="cp-block mb16"><div class="cp-block-label"><i class="ti ti-device-floppy"></i> کاهش مصرف پهنای باند</div><label style="display:inline-block;position:relative;width:44px;height:24px;cursor:pointer"><input type="checkbox" id="nl-bwsaver" style="opacity:0;width:0;height:0;position:absolute"><span style="position:absolute;inset:0;background:rgba(255,255,255,.1);border:1.5px solid var(--glass-b);border-radius:12px;cursor:pointer;transition:.3s"></span></label><div style="font-size:11px;color:var(--t3);margin-top:6px">فشرده‌سازی Brotli — کاهش ۱۵-۴۰٪ مصرف ترافیک</div></div>
